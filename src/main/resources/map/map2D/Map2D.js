...
//	ctx.translate(-this.viewport.w/2, -this.viewport.h/2);
	...
	for(var pass = 0; pass < 3; pass++) {
		for (var i = 0; i < this.__drawables.length; i++) {
			var rendered = this.__drawables[i].draw(ctx, this.viewport, pass);
			if(rendered && pass == 2 && this.__drawables[i] instanceof Q.TagDrawable) {
				tagsRendered++;
			}
		}
	}
	//console.log("Tags rendered: " + tagsRendered);
